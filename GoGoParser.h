...
public:
  ...
  enum {
    RuleProg = 0, RuleStat = 1, RuleDeclaration = 2, RuleFunc_defintion = 3, 
    RuleFunc_call = 4, RuleFunc_call_params = 5, RuleParam = 6, RuleParams = 7, 
    RuleCompound_stmt = 8, RuleExpr = 9, RuleIf_stmt = 10, RuleElse_stmt = 11, 
    RuleWhile_loop_stmt = 12, RuleReturn_stmt = 13, RuleAssignment_stmt = 14
  };
  ...
  public:
    ...
    Func_defintionContext *func_defintion();
  ...
  class  Func_defintionContext : public antlr4::ParserRuleContext {
  public:
    Func_defintionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ID();
